module Api
  class UsersController < ApplicationController
    ...
    def subscription_changed
      ...
      if params["data"].present? && data_plan_params["expiry_date"].present? && data_plan_params["plan"]["id"].present? && data_plan_params["customer_id"]
        subscription_expiration = data_plan_params["expiry_date"]
        subscription = data_plan_params["plan"]["id"]
    ...
    def get_data_plan_params
      params.require("data").permit("expiry_date", "customer_id", "plan":["id"])
    end
