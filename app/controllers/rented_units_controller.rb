class RentedUnitsController < ApplicationController
  ...
  private
    ...
    def rented_unit_params
      params.require(:rented_unit).permit(:name, :year_built, :rent, :bedrooms, :bathrooms, :sales_price, :num_units, :price_per_unit, :price_per_sf, :cap_rate, :grm, :close_of_escrow, :image_url, :package_id)
    end
end
