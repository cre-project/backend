...
class OperatingStatementFieldsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should get index" do
    get operating_statement_fields_url, as: :json
