...
class OperatingStatementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should get index" do
    get api_operating_statements_url, as: :json
    assert_response :success
  end

  test "should create operating_statement" do
    assert_difference('OperatingStatement.count') do
      post api_operating_statements_url, params: { operating_statement: {  } }, as: :json
    end
  ...
  test "should show operating_statement" do
    get api_operating_statement_url(@operating_statement), as: :json
    assert_response :success
  end

  test "should update operating_statement" do
    patch api_operating_statement_url(@operating_statement), params: { operating_statement: {  } }, as: :json
    assert_response 200
  end

  test "should destroy operating_statement" do
    assert_difference('OperatingStatement.count', -1) do
      delete api_operating_statement_url(@operating_statement), as: :json
    end
